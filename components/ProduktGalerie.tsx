"use client"; // 🔧 Client komponenta pro interaktivní galerii
...
// 🖼️ Props pro komponentu galerie
interface ProduktGalerieProps {
  obrázky: string[]; // 🎨 Seznam obrázků produktu
  názevProduktu: string; // 📝 Název produktu pro alt text
}

// 🖼️ Interaktivní galerie obrázků s modal a navigací
export default function ProduktGalerie({ obrázky, názevProduktu }: ProduktGalerieProps) {
  // 🎛️ Stavy pro správu galerie
