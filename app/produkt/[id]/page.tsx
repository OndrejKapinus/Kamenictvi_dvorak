...
import { GalerieProduktu } from "@/components/GalerieProduktu";
import { CheckCircle2, XCircle, ShoppingCart, ArrowLeft, Package, Truck, Shield } from "lucide-react";

// 🎯 Generování statických parametrů pro všechny produkty
export async function generateStaticParams() {
  return produkty.map((produkt) => ({
    id: produkt.id, // 🔑 ID každého produktu pro statické vygenerování
  }));
}

// 🛍️ Detail produktu - zobrazuje veškeré informace o produktu (statická stránka)
      ...
      <section className="py-12 md:py-16">
        <div className="container px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <GalerieProduktu obrázky={produkt.obrázky} názevProduktu={produkt.název} />
